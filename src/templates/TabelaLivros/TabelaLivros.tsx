...
function TabelaLivros({ livros, handleExcluir, nextPage, prevPage, currentPage }: { livros: Livro[], handleExcluir: (id: number) => void, nextPage: () => void, prevPage: () => void, currentPage: number }) {
        ...
        <div className="p-5 ">
            <div className=" bg-white shadow-md rounded-md p-4 overflow-x-auto w-full max-w-full">
                ...
                <div className="mt-4 flex justify-end items-center">
                    ...
                    <div className="bg-gray-400 mx-1 px-4 py-2 text-white rounded">
